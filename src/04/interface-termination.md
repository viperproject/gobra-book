...
- TODO [issue #864](https://github.com/viperproject/gobra/issues/864) 
</div>

If an interface method specifies termination, any implementation method must be proven to terminate.
...
For example, if the constant termination measure is `decreases 5`, an implementation must use a smaller constant, e.g., `decreases 3`.
...
It is admissible for an interface method not to specify termination, but implementation methods may optionally provide termination measures.
